...
| CORPUS-014 SuperTux 0.7.0 win32 | game | i386 | entry | 10M still OpenAL table init; 50M + `--datadir` CreateWindowExW last 0x10024, ChoosePixelFormat 1, SetPixelFormat 1, wglCreateContext 0x5000c, SetFilePointerEx 1, then unsupported_opcode 0x0f e0 PAVGB at libpng16 (42080197 instruction, 8320 HLE) → BPTK-010 |
...
and stops **unsupported_opcode `0x0f 0xe0` PAVGB** at `libpng16+0x2080b`
at **42080197** instruction / **8320** HLE.
...
SuperTux work is i386 `PAVGB` (`0F E0`, packed unsigned-byte average) so
