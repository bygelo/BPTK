...
All 45 product benchmark specification remains red. BPTK-003, BPTK-007, BPTK-008, BPTK-017, BPTK-037, BPTK-038, BPTK-043, and BPTK-044 are active and implemented-but-red; the other 37 are excluded. A red specification is not evidence that a capability passes.
...
2. `npm test` runs fifty-one Node.js test after checking the status snapshot against its content-addressed roadmap source.
