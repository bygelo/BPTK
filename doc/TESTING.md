...
All 45 product benchmark specification remains red. BPTK-003, BPTK-007, BPTK-008, BPTK-017, BPTK-037, BPTK-038, BPTK-039, BPTK-043, BPTK-044, and BPTK-045 are active and implemented-but-red; the other 35 are excluded. A red specification is not evidence that a capability passes.
...
2. `npm test` runs fifty-six Node.js test after checking the status snapshot against its content-addressed roadmap source.
