...
function liftSse(cursor, state, op2) {
  ...
  // The no-prefix / 66 forms of 0F 12 / 0F 16 are MOVLPS/MOVHPS/MOVLPD/MOVHPD,
  // half-register loads outside this SSE3 addition — left as an honest refusal
  // until a served binary reaches one.
