  ...
  while (stopReason === null && instructionCount < instructionBudgetCount) {
    ...
    try {
      ...
      while (opcode === 0x66 || opcode === 0x67 || opcode === 0xf2 || opcode === 0xf3) {
        // The operand-size override (0x66) selects the 16-bit operand form
        // of the next instruction (BPTK-009 subset widening); the
        // address-size override stays outside the bounded probe.
