...
function executeProbe(mapped, instructionBudgetCount, option = {}) {
  ...
  function withinBudget() {
    ...
    return instructionCount < budgetContinueLimit && infiniteWaiterRunnable();
  }
  ...
  if (stopReason === null && instructionCount >= instructionBudgetCount && !infiniteWaiterRunnable()) stopReason = "instruction_budget_exhausted";
  if (stopReason === null && instructionCount >= budgetContinueLimit) stopReason = "instruction_budget_exhausted";
