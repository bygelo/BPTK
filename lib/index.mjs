...
export { assertCapsWithinSupport, computeFrameDiff, declaredCaps, emitWgsl, evaluateProgram, formatProgram, generateFixedFunction, generateProjectiveTexgen, generateReferenceFrame, parseD3d9PixelShader, referenceProjectiveTexgenFrame, renderProjectiveTexgenFrame } from "./shader.mjs";
