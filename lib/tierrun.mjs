...
//     marks NOT resumable (an out-of-region FAULT, where a guest store was lost to
//     the trap page): that run is discarded whole and the call is re-interpreted
//     from the callee's entry.
//
