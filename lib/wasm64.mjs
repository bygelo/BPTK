...
function createEmitter(push, loadBase, xmmBase = 0, plan = null, faultExit = null) {
...
export function compileFunction(image, option = {}) {
  ...
  const { emitNode, emitRet, emitCondition, emitToOffset, emitReadOperand, setFaultSite } = createEmitter(push, loadBase, xmmBase, plan, plan.multi ? faultExit : null);
