...
// bytes), not a recorded glDrawArrays. SDL software video still wins when the
// guest opened an SDL framebuffer.
export function composeGuestSurface(guest) {
  ...
  if (guest.gl !== undefined && typeof guest.gl.presentFramebuffer === "function") {
