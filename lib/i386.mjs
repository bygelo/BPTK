...
export const i386Opcode0f = Object.freeze([
  ...
  0xbe, 0xbf, 0xc0, 0xc1, ...range(0xc8, 0xcf), // BSWAP r32: 0F C8+rd, no ModRM
  0xe0, // PAVGB mm/xmm: packed unsigned-byte average, prefix selects MMX vs SSE2
  0xea, // PMINSW mm/xmm: packed signed-word min, prefix selects MMX vs SSE2
  ...
  0x5b, 0x5c, 0x5d, 0x5e, 0x5f, 0x2e, 0x2f, 0x2a, 0x2c, 0x2d, 0xc4, 0xc5, 0xc6, 0xe6,
]);
...
export function decodeSweepInstruction(bytes, offset) {
  ...
  if (opcode === 0x0f) {
    ...
    cursor += 1;
    if (extension === 0xa2 || extension === 0x31 || extension === 0x77 || (extension >= 0xc8 && extension <= 0xcf)) {
      return { length: cursor - offset, opcode: 0x0f00 | extension, is_served: true };
    }
