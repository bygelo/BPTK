...
export function decodeSweepInstruction(bytes, offset) {
  ...
  if (opcode === 0x0f) {
    ...
    cursor += 1;
    if (extension === 0xa2 || extension === 0x31) return { length: cursor - offset, opcode: 0x0f00 | extension, is_served: true };
    ...
    if (extension === 0xa4 || extension === 0xac || extension === 0xba) length += 1;
