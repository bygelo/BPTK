...
export const i386OpcodeOneByte = Object.freeze([
  ...
  0x8d, 0x8f, 0x90, ...range(0x91, 0x99), 0x9b, 0x9c, 0x9d, 0x9e, 0x9f,
...
export function decodeSweepInstruction(bytes, offset) {
  ...
  if (opcode === 0x0f) {
    ...
    if (extension === 0xa4 || extension === 0xac || extension === 0xba || extension === 0x70 || extension === 0x71 || extension === 0x72 || extension === 0x73 || extension === 0xc2 || extension === 0xc6) length += 1;
