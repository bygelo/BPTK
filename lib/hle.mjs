...
import { findResource, loadDialogTemplate, parseDialogTemplate, resourceType } from "./rsrc.mjs";
...
export function hleCrtDataLayout(layout) {
  ...
  return Object.freeze({ iob_base, utc_address, tzname_base, mb_cur_max_cell, environ_cell, wenviron_cell, cursor });
}
