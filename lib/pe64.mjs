...
function readExecutable(input) {
  // The byte-driven entry (lib/present.mjs) maps a PE32+ image from memory with
  // no filesystem, so a pre-read Uint8Array/Buffer is accepted directly and the
  // fs path below is skipped. String input keeps its exact prior behavior.
